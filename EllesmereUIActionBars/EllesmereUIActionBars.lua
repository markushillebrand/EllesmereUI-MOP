...
local SHAPE_MEDIA = "Interface\\AddOns\\EllesmereUI-MoP\\media\\portraits\\"
local SHAPE_MASKS = {
...
local function LayoutBar(key)
    ...
    if not isAnchored then
        ...
        elseif not pos and curPt ~= "CENTER" then
            -- No saved position yet: default to screen center rather than the
            -- UIParent origin, which otherwise renders the bar in the
            -- bottom/top-left corner the first time it is enabled.
            frame:ClearAllPoints()
