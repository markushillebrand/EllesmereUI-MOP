...
local function ScanForQuestItem()
    -- MoP may not expose the modern C_QuestLog entry API; degrade gracefully
    -- (quest-item hotkey simply finds nothing rather than erroring).
    if not (C_QuestLog and C_QuestLog.GetNumQuestLogEntries and C_QuestLog.GetInfo) then return nil end
