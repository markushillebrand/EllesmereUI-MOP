...
initFrame:SetScript("OnEvent", function(self)
    ...
    local ICONS_PATH = "Interface\\AddOns\\EllesmereUI-MoP\\media\\icons\\"
    ...
    local ENEMY_PORTRAIT_PATH = "Interface\\AddOns\\EllesmereUI-MoP\\media\\enemy-portrait.png"

    -- Portrait mask/border media paths (for detached portrait shape preview)
    local PORTRAIT_MEDIA_P = "Interface\\AddOns\\EllesmereUI-MoP\\media\\portraits\\"
    ...
    local function BuildUnitPreview(parent, unitKey, side)
        ...
        if unitKey == "player" or unitKey == "target" or unitKey == "focus" then
            ...
            local PREV_ABS_TEX = {
                striped  = "Interface\\AddOns\\EllesmereUI-MoP\\media\\textures\\shields\\striped3.tga",
                clean    = "Interface\\Buttons\\WHITE8X8",
                blizzard = "Interface\\AddOns\\EllesmereUI-MoP\\media\\textures\\shields\\blizzard.tga",
            }
        ...
        local COMBAT_MEDIA_P = "Interface\\AddOns\\EllesmereUI-MoP\\media\\combat\\"
