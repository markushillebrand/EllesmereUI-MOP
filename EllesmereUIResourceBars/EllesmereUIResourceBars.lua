...
--  Constants
-------------------------------------------------------------------------------
local RB_FONT_FALLBACK = "Interface\\AddOns\\EllesmereUI-MoP\\media\\fonts\\Expressway.TTF"
...
-------------------------------------------------------------------------------
local TEX_BASE = "Interface\\AddOns\\EllesmereUI-MoP\\media\\textures\\"
...
-------------------------------------------------------------------------------
local BAR_TEX_BASE = "Interface\\AddOns\\EllesmereUI-MoP\\media\\textures\\"
local BAR_TEXTURES = {
    ["none"]          = nil,
...
--  Player Cast Bar
-------------------------------------------------------------------------------
local SPARK_TEX = "Interface\\AddOns\\EllesmereUI-MoP\\media\\cast_spark.tga"
...
function ERB:OnEnable()
    ...
    -- MoP: UNIT_POWER_POINT_CHARGE is retail-only; guard the registration so an
    -- invalid-event error can't abort setup. The handler simply never fires.
    pcall(eventFrame.RegisterUnitEvent, eventFrame, "UNIT_POWER_POINT_CHARGE", "player")
