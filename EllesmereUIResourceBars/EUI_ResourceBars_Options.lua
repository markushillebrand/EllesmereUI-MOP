...
initFrame:SetScript("OnEvent", function(self)
    ...
    local function BuildThresholdSettingsButton(cfg)
        ...
        local CLOSE_ICON_PATH = "Interface\\AddOns\\EllesmereUI-MoP\\media\\icons\\eui-close.png"
        local POPUP_W = 410
        local POPUP_PAD = 14
        local ROW_GAP = 6
    ...
    local function BuildBarDisplayPage(pageName, parent, yOffset)
        ...
        do
            ...
            do
                local _, classFile = UnitClass("player")
                local SPRITE = "Interface\\AddOns\\EllesmereUI-MoP\\media\\icons\\class-full\\glyph.tga"
                local COORDS = {
    ...
    local _castBarPreviewBuilder = function(hdr, hdrW)
        ...
        spark:SetTexture("Interface\\AddOns\\EllesmereUI-MoP\\media\\cast_spark.tga")
