...
initFrame:SetScript("OnEvent", function(self)
    ...
    local function BuildNameplatePreview(parent, parentW)
        ...
        local MARKER_PATH = "Interface\\AddOns\\EllesmereUI-MoP\\media\\marker.png"
        ...
        classIcon:SetTexture("Interface\\AddOns\\EllesmereUI-MoP\\media\\elite-rare-indicator.png")
        ...
        castParts.spark:SetTexture("Interface\\AddOns\\EllesmereUI-MoP\\media\\cast_spark.tga")
