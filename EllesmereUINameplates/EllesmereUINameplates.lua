...
ns.NP_ABSORB_STYLE_TEX = {
    blizzard = "Interface\\AddOns\\EllesmereUI-MoP\\media\\textures\\shields\\blizzard-nameplates.png",
...
local defaults = {
    ...
    showEnemyPets = false,
    font = "Interface\\AddOns\\EllesmereUI-MoP\\media\\fonts\\Expressway.TTF",
...
do
    local TB = "Interface\\AddOns\\EllesmereUI-MoP\\media\\textures\\"
...
local frameCache = CreateFramePool("Frame", UIParent, nil, nil, false, function(plate)
    ...
    plate.castSpark:SetTexture("Interface\\AddOns\\EllesmereUI-MoP\\media\\cast_spark.tga")
