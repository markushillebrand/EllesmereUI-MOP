...
local DEFAULT_CATEGORIES = {
    ...
    { name = "Reagent Bag",        types = {}, isReagentBag = true, noGroup = true, icon = "Interface\\Icons\\INV_Misc_Bag_08" },
    { name = "Item Set Gear",      types = { IC_ARMOR, IC_WEAPON }, isSetGear = true, icon = "Interface\\Icons\\INV_Chest_Plate03" },
    ...
    { name = "Armor",              types = { IC_ARMOR }, excludeEquipSlots = { "INVTYPE_TRINKET" }, icon = "Interface\\Icons\\INV_Chest_Plate01" },
    { name = "Consumables",        types = { IC_CONSUMABLE },                icon = "Interface\\Icons\\INV_Potion_51" },
    { name = "Trade Goods",        types = { IC_TRADESKILL, IC_REAGENT },    icon = 132996 },
    { name = "Gear Enhancements",  types = { IC_GEM, IC_ITEM_ENHANCE },     icon = "Interface\\Icons\\INV_Misc_Gem_01" },
    { name = "Professions",        types = { IC_PROFESSION, IC_RECIPE },     icon = "Interface\\Icons\\Trade_BlackSmithing" },
    { name = "Housing",            types = { IC_HOUSING },                   icon = "Interface\\Icons\\INV_Misc_Note_01" },
    { name = "Miscellaneous",      types = { IC_MISC, IC_CONTAINER }, isCatchAll = true, icon = "Interface\\Icons\\INV_Misc_QuestionMark" },
}
