...
local FONT_PATH   = (EllesmereUI and EllesmereUI.GetFontPath and EllesmereUI.GetFontPath("extras"))
    or "Interface\\AddOns\\EllesmereUI-MoP\\media\\fonts\\Expressway.TTF"
...
local LOCK_INNER  = "Interface\\AddOns\\EllesmereUI-MoP\\media\\eui-unlocked-inner-2.png"
local LOCK_OUTER  = "Interface\\AddOns\\EllesmereUI-MoP\\media\\eui-unlocked-outer-2.png"
local LOCK_TOP    = "Interface\\AddOns\\EllesmereUI-MoP\\media\\eui-unlocked-top-2.png"
...
local function CreateGrid(parent)
    ...
    local NUM_SEGS       = 5
    local FLASH_PATH = "Interface\\AddOns\\EllesmereUI-MoP\\media\\unlock-flash.png"
...
local function CreateBlizzOwnedOverlay(def, parent)
    ...
    actionBtn:SetScript("OnClick", function()
        if InCombatLockdown() then return end
        -- MoP Classic ships a backported Blizzard Edit Mode, but entering it
        -- from addon code taints the protected ClearTarget() call it makes on
        -- enter (ADDON_ACTION_FORBIDDEN). EllesmereUI-MoP uses its own unlock
        -- system and does not hand off to Blizzard Edit Mode, so just close.
        if EllesmereUI.Compat and EllesmereUI.Compat.isMoPClassic then
            ns.RequestClose(false)
            return
        end
...
local function CreateMover(barKey)
    ...
    ---------------------------------------------------------------------------
    local ICON_PATH = "Interface\\AddOns\\EllesmereUI-MoP\\media\\icons\\"
...
-------------------------------------------------------------------------------
local GRID_ICON       = "Interface\\AddOns\\EllesmereUI-MoP\\media\\icons\\grid.png"
local MAGNET_ICON     = "Interface\\AddOns\\EllesmereUI-MoP\\media\\icons\\magnet.png"
local FLASHLIGHT_ICON = "Interface\\AddOns\\EllesmereUI-MoP\\media\\icons\\flashlight.png"
local HOVER_ICON      = "Interface\\AddOns\\EllesmereUI-MoP\\media\\icons\\hover.png"
local DARK_OVERLAY_ICON = "Interface\\AddOns\\EllesmereUI-MoP\\media\\icons\\dark-overlay.png"
local COORD_ICON      = "Interface\\AddOns\\EllesmereUI-MoP\\media\\icons\\coordinates.png"
local BANNER_TEX      = "Interface\\AddOns\\EllesmereUI-MoP\\media\\eui-unlocked-banner-2.png"
...
local function CreateUnlockFrame()
    ...
    local function GetAnchorLine(idx)
        ...
        line:SetTexture("Interface\\AddOns\\EllesmereUI-MoP\\media\\textures\\soft-line")
