...
local ADDON_NAME = ...
local GRADIENT_TEX = "Interface\\AddOns\\EllesmereUI-MoP\\media\\party.png"
...
pmInit:SetScript("OnEvent", function(self, event, ...)
    if event == "PLAYER_LOGIN" then
        ...
        -- PVP_MATCH_COMPLETE is retail-only (Shadowlands+); skip on MoP Classic.
        EllesmereUI_RegisterEventSafe(self, "PVP_MATCH_COMPLETE")
