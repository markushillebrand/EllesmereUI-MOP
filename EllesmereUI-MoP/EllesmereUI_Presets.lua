...
do
    ...
    function EllesmereUI:ShowSpecAssignPopup(opts)
        ...
        if not specPopup then
            local FONT = EllesmereUI._font or ("Interface\\AddOns\\EllesmereUI-MoP\\media\\fonts\\Expressway.ttf")
            local COL_W = 165
            local COL_GAP = 12
        ...
        if defaultKey and allPresetKeysFn then
            ...
            specPopup._rebuildDefMenu = function()
                ...
                local mH = 4
                local ITEM_FONT = EllesmereUI._font or ("Interface\\AddOns\\EllesmereUI-MoP\\media\\fonts\\Expressway.ttf")
