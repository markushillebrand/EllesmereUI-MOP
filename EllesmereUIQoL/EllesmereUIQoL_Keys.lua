...
local function BuildPopup()
    ...
    xTex:SetAllPoints()
    xTex:SetTexture("Interface\\AddOns\\EllesmereUI-MoP\\media\\icons\\eui-close.png")
    ...
    refTex:SetAllPoints()
    refTex:SetTexture("Interface\\AddOns\\EllesmereUI-MoP\\media\\icons\\unlock-reset.png")
