...
function ns.BM_BuildPage(pageName, parent, yOffset)
    ...
    local CLASS_SPRITE_TEX = "Interface\\AddOns\\EllesmereUI-MoP\\media\\icons\\class-full\\modern.tga"
    ...
    do
        ...
        do
            local EYE_VIS = "Interface\\AddOns\\EllesmereUI-MoP\\media\\icons\\eui-visible.png"
            local EYE_INVIS = "Interface\\AddOns\\EllesmereUI-MoP\\media\\icons\\eui-invisible.png"
