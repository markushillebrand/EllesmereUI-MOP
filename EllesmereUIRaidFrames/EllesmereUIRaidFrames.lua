...
local ABSORB_STYLE_TEX = {
    striped  = "Interface\\AddOns\\EllesmereUI-MoP\\media\\textures\\shields\\striped-5.png",
...
local function ApplyDispelOverlay(d, dc, s)
    ...
    elseif mode == "gradient" then
        ...
        olTex:SetTexture("Interface\\AddOns\\EllesmereUI-MoP\\media\\textures\\gradient-tb.tga")
    ...
    if f._raidMarker then
        ...
        if isMarked then
            ...
            if index == previewRoles._markerSlot1 then
                f._raidMarker:SetTexture("Interface\\AddOns\\EllesmereUI-MoP\\media\\marker.png")
                f._raidMarker:SetTexCoord(0, 1, 0, 1)
            else
                f._raidMarker:SetTexture("Interface\\AddOns\\EllesmereUI-MoP\\media\\marker2.png")
                f._raidMarker:SetTexCoord(0, 1, 0, 1)
            end
